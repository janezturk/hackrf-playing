...
class moohero_power(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "moohero_power")
        ...
        self.osmosdr_source_0_0.set_center_freq(868.8e6, 0)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/tmp/binfile', False)
        ...
        self.connect((self.digital_gfsk_demod_0, 0), (self.qtgui_time_raster_sink_x_0, 0))
        ...
        self.connect((self.osmosdr_source_0_0, 0), (self.blocks_throttle_0, 0))
...
def main(top_block_cls=moohero_power, options=None):
