...
class caddy_keys(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "caddy_keys")
        ...
        self.osmosdr_source_0_0.set_center_freq(434.3e6, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/tmp/car', False)
...
def main(top_block_cls=caddy_keys, options=None):
