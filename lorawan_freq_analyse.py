...
class lorawan_freq_analyse(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lorawan_freq_analyse")
...
def main(top_block_cls=lorawan_freq_analyse, options=None):
